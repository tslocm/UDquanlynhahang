...
//	}
	...
	public ThongKeMonAnUI() {
		...
		String[] header = "STT;Mã Món Ăn;Tên Món Ăn;Loại Món;Giá Tiền".split(";");
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
								...
								.addGroup(gl_contentPane.createSequentialGroup()
										...
										.addGap(40)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
												.addComponent(btnThongKe, GroupLayout.PREFERRED_SIZE, 118,
														GroupLayout.PREFERRED_SIZE)
												.addGroup(gl_contentPane.createSequentialGroup()
														.addComponent(cbxNam, 0, 129, Short.MAX_VALUE).addGap(33))
												.addComponent(btnBaoCao, GroupLayout.PREFERRED_SIZE, 118,
														GroupLayout.PREFERRED_SIZE))))
								.addGap(25).addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 728, Short.MAX_VALUE)
								.addGap(30))))
				.addGroup(gl_contentPane.createSequentialGroup().addGap(446)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
						...
						.addGap(26).addComponent(btnBaoCao, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE))
		...
		try {
			...
			if (rdbThang.isSelected()) {
				...
				if (loai.equalsIgnoreCase("Bán chạy nhất")) {
					...
					maMons = monDAO.ThongKeMonAnItNhatTrongThang(Integer.parseInt(thang), Integer.parseInt(nam),
							"Đồ Uống");
					mons = convertStringtoMon(maMons);
				}
				...
				if (loai.equalsIgnoreCase("Bán chạy nhất")) {
					...
					maMons = monDAO.ThongKeMonAnItNhatTrongNam(Integer.parseInt(nam), "Đồ Uống");
					mons = convertStringtoMon(maMons);
				}
			}
		} catch (Exception e) {
